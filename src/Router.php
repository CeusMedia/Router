...
class Router{
	...
	public function __construct( $options = array() ){
		...
		$this->registry	= new \CeusMedia\Router\Registry();
		$this->resolver	= new \CeusMedia\Router\Resolver( $this->registry );
	}

	public function add( $controller, $action = 'index', $pattern, $method = '*' ){
		$route	= new  \CeusMedia\Router\Route( $controller, $action, $pattern, strtoupper( $method ) );
